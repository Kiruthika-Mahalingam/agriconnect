...
//                 <Route path="/successstories" element={<SuccessStories />} />
//                 <Route path="/marketprices" element={<MarketPrices />} />
//                 <Route path="/events/*" element={<Events />} /> {/* Updated Events route */}
...
//                         <br />
//                         <br />
//                         <span className="error">Oops, there was an error fetching weather data.</span>
//                       </>
//                     )}
//                     {weather.data?.current && !weather.loading && !weather.error && (
