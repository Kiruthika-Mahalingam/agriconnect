...
const UserProfiles = () => {
  const users = [
    { id: 1, name: 'manisha', contributions: 25, img: 'https://via.placeholder.com/80' },
    { id: 2, name: 'sangeetha', contributions: 18, img: 'https://via.placeholder.com/80' },
    { id: 3, name: 'diya', contributions: 30, img: 'https://via.placeholder.com/80' },
    { id: 4, name: 'kiruthika', contributions: 22, img: 'https://via.placeholder.com/80' }
  ];
